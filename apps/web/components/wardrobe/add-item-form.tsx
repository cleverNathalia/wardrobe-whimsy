...
interface AddItemFormProps {
  ...
  /**
   * A placeholder name like `item-0428`, so the required field is pre-filled.
   * Generated by the server component that renders this form — producing it
   * here would differ between the server and client renders.
   */
  defaultName?: string
}

export function AddItemForm({ wardrobeId, googlePhotosEnabled = false, defaultName }: AddItemFormProps) {
