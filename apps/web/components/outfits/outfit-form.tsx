...
interface OutfitFormProps {
  ...
  /**
   * A placeholder name like `outfit-0428`, so the required field is pre-filled.
...
export function OutfitForm({ wardrobeId, wardrobeItems, defaultName }: OutfitFormProps) {
